...
export default function SettingsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-1 flex-col items-center justify-center bg-white text-black transition-colors duration-300 dark:bg-neutral-700 dark:text-white">
